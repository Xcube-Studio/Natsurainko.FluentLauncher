...
public class NotificationGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(groupedItems, static (ctx, item) =>
        {
            ...
            ctx.AddSource($"{@namespace}.{@class}.g.cs", 
                ...
                using DefaultNotification = global::Natsurainko.FluentLauncher.Services.UI.Notification.DefaultNotification;
                using NotificationType = global::FluentLauncher.Infra.UI.Notification.NotificationType;
    ...
    private static void GenerateItem((IMethodSymbol, AttributeData) itemInfo, StringBuilder memberBuilder)
    {
        ...
        string genericType = attribute.AttributeClass!.TypeArguments
            .First().GetFullyQualifiedName();

        Dictionary<string, string> properties = attribute.GetProperties();
        ...
        if (properties.ContainsKey("Type"))
            properties["Type"] = "(NotificationType)" + properties["Type"];
        ...
        $$"""
                ...
                {
                    {{firstParameterName}}.Show<{{genericType}}>(new DefaultNotification
                    {
