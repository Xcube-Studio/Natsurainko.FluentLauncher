...
using Natsurainko.FluentLauncher.ViewModels.Downloads.TexturePacks;
using Natsurainko.FluentLauncher.XamlHelpers.Converters;
using Nrk.FluentCore.Resources;

namespace Natsurainko.FluentLauncher.Views.Downloads.TexturePacks;
    ...
    private void ContentFrame_Navigated(object sender, NavigationEventArgs e)
    {
        ...
        else
        {
            if (contentFrame.Content is ResourcePage)
            {
                ...
                breadcrumbBar.SetPath($"TexturePacksDownload/{resourceName}");
            }
            else if (contentFrame.Content is ResourceDefaultPage)
            {
                breadcrumbBar.AddItem("TexturePacksDownload");
            }
        }
    }
